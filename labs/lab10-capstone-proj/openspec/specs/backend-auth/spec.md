...
Defines the authentication requirements for the NestJS backend: Google OAuth 2.0 flow, JWT (RS256) signing and verification, user persistence, and the auth endpoints.
