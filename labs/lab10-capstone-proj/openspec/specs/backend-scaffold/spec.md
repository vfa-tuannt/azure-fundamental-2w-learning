...
Defines the foundational backend scaffolding requirements: NestJS application bootstrap, database connectivity, CORS, environment configuration, and CI validation.
