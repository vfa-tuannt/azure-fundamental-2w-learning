...
- **[Risk]** Private Postgres + App Service VNet integration adds latency vs public endpoints. → **Mitigation:** Same region (Japan East) for VNet and DB → keeps RTT under 5ms. Empirically acceptable.
